...
export default function AnalyticsPage() {
  ...
  const aggregateAnalytics = (): AggregatedAnalytics => {
  ...
  useEffect(() => {
    const updateAnalytics = () => {
      const updated = aggregateAnalytics();
      setAnalytics(updated);
    };

    updateAnalytics();
    window.addEventListener("storage", updateAnalytics);
    return () => window.removeEventListener("storage", updateAnalytics);
  }, []);
